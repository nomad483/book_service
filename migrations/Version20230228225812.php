 ...
 */
final class Version20230228225812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, authors TEXT NOT NULL, isbn VARCHAR(13) NOT NULL, description TEXT NOT NULL, publication_date DATE NOT NULL, meep BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE book_to_book_format (id INT NOT NULL, book_id INT NOT NULL, format_id INT NOT NULL, price INT NOT NULL, discount_percent NUMERIC(10, 0) DEFAULT NULL, PRIMARY KEY(id))');
